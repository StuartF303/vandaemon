...
| Stale `VANDIMMER-4CH2A.net` | Dated 17 Aug, predates two GPIO map changes, still shows gate inputs on IO4–IO7. Nothing in `tools/` reads it. Regenerate or delete before it misleads someone. |
